...
\noindent\textbf{Ilias} 
 \begin{enumerate}
 \item \textbf{Alle} Kursinhalte, so wie \textbf{Ankündigungen}, Folien, Pflichtlektüre und weiterführende Infos/Materialien werden im Ilias zur Verfügung gestellt. Auch \textbf{Podcast} (Aufzeichnungen der Vorlesung) stehen dort zeitverzögert bereit.
...
\begin{itemize}
    \item Bitte senden Sie mir eine Frage per \myemail{gracia.brueckmann@unibe.ch}{[KKI2024]}{Email} (bis Freitagmittag, 12:30h) zu, in der Sie bitte kurz anhand der verfügbaren Materialien darlegen, worauf sich Ihre Frage bezieht.
